...
class GUI:
    ...
    def showUnitStatistics(self,t_unit):  
        ...
        self.show_progressbar(t_unit.experience,self.progressbar_gre,t_exploc)
        self.show_progressbar(t_unit.rank,self.progressbar_gre,t_rank)
        self.show_progressbar(t_unit.dep,self.progressbar_gre,t_dep)
        self.show_progressbar(t_unit.atk,self.progressbar_gre,t_atk)
                    ...
                    if event.key == pygame.K_1:
                        ...
                        if len(sel_AIunits)==0:
                            if sel_ctr < MAX_UNITS: 
                                ...
                                myUI.showLabelOnStage("Maximum unit selection has been reached.",(500,550),myUI.FONTSTYLE,14,myUI.YELLOW)                       
                    ...
                    if event.key == pygame.K_a:
                        ...
                        if game_round % 2 > 0:                            
                            ...
                            if not isInvalidAttack:
                                ...
                                ai_unit = ai[cur_index_ai]
                                #myUI.refresh_score_data(human,ai)
                                #myUI.showLabelOnStage("AI is selecting Attacker and Target...",(420,300),myUI.FONTSTYLE,15,myUI.YELLOW)
                                #time.sleep(2)
                                myUI.setStage()
                                #myUI.setScoreboard()
                                myUI.updateCharacter(ai_unit)
                                ...
                                #myUI.showLabelOnStage("AI is attacking...",(420,300),myUI.FONTSTYLE,15,myUI.YELLOW)
                                #time.sleep(2)
