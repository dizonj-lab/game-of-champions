...
class GUI:
    ...
    def showLabelOnStage(self,t_msg,t_loc,t_font,t_size,t_color):
        ...
        # self.writeCenterToScreen(t_msg,t_locx,t_locy,t_color,t_font,t_size)
        # text = font.render(t_msg, 1, pygame.Color(t_color))
        # text_rect = text.get_rect(center=(self.window_width/2, t_loc(1)))
    ...
    def showUnitStatistics(self,t_unit):  
        ...
        self.show_progressbar(t_unit.rank,self.progressbar_gre,t_rank,10)
...
def setupPlayer(t_player,avatar,prefixname):
      for sel in range(len(avatar)):
        ...
        #t_player.append(Player(init_name, init_prof, init_index, init_state, init_atk, init_dep, init_avatar, init_icon,init_posx,init_posy,init_avatarsize))
        #                            name, profession, playertype,      index,       state,      atk,       dep,      avatar,     icon,     posx,      posy,    avatarsize
...
avatar = [
    ...
    [dirname + "/assets/char4.png",dirname + "/assets/char4_head.png","TANK",tank_atk,tank_dep,100,150,(388,439),dirname + "/assets/char4_profile.png",(90,80),(200,600)],
            ...
            if not game_over:          
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_a:
                        ...
                        if game_round % 2 > 0:                            
                           ...
                           # ai's turn
                            ...
                            myUI.refresh_score_data(human,ai)
                            #myUI.showLabelOnStage("AI is selecting an attacker and a target...",(400,400),myUI.FONTSTYLE,20,myUI.WHITE)
                            myUI.writeCenterScreen(" AI is selecting an attacker and a target...", 400, 400, myUI.WHITE,myUI.FONTSTYLE,20)
                            ...
                            #time.sleep(3)
                            #myUI.showLabelOnStage("AI is attacking target...",(500,400),myUI.FONTSTYLE,20,myUI.WHITE)
                            myUI.writeCenterScreen(" AI is attacking target...", 500, 400, myUI.WHITE,myUI.FONTSTYLE,20)
                            pygame.display.update()
                            #time.sleep(2)
                    ...
                    if event.key == pygame.K_h:
                        ...
                        if game_round % 2 > 0:                            
                            ...
                            if not isInvalidHealAction:
                                ...
                                #ai_unit = ai[rand_aliveai_index]
                                #myUI.refresh_score_data(human,ai)
                                #myUI.showLabelOnStage("AI is selecting unit to heal...",(420,300),myUI.FONTSTYLE,15,myUI.YELLOW)
                                #time.sleep(2)
                                human_unit = human[cur_index_human]
                                ai_unit = ai[cur_index_ai]
                                myUI.setStage()
                                ...
                                #myUI.showLabelOnStage("AI is healing it's unit...",(420,300),myUI.FONTSTYLE,15,myUI.YELLOW)
                                #time.sleep(2)
                                ai_unit.heal()
                                #isVirtualMove = False
                                #virtualKeypress = ""
                    ...
                    if event.key == pygame.K_p:
                        ...
                        if game_round % 2 > 0:
                            #myUI.showLabelOnStage("Human player passed a round! ",(450,300),myUI.FONTSTYLE,15,myUI.YELLOW)
                            myUI.writeCenterScreen(" Human player passed a round!", 450, 300, myUI.WHITE,myUI.FONTSTYLE,20)
                            #isVirtualMove = True
                            #virtualKeypress = random.choices(["a","h","p"])
                        else:
                            #myUI.showLabelOnStage("AI player passed a round!",(470,300),myUI.FONTSTYLE,15,myUI.YELLOW)
                            myUI.writeCenterScreen(" AI player passed a round!", 470, 300, myUI.WHITE,myUI.FONTSTYLE,20)
                             #isVirtualMove = False
                             #virtualKeypress = ""
