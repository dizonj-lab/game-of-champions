"""
    ...
    Version     : v1.10
    Date        : 3-Mar 2022
    Description : A turn-based game developed in Python and PyGame.
                : This program is a requirement for PT DICT 421, PT DICT 122, PT DNDFC 221, PT DNDFC 122 - Introduction to Programming.
    Instructor  : David Tuk Wai Leong
    Programmer  : Dizon Joselito Villanueva
    
    System Requirements:
                : Python 3.10.1 64-bit or later
                : Pygame 2.1.2
                : Windows 10, MacOS (w/ Intel Processor)
    
    Known Limitations:
                : Does not work in MacOS on M1 Processor
"""
...
# class object to manipulate the PyGame based UI
class GUI:
    def __init__(self):
    ...
    # set the header (title) for the game scene
    def setHeader(self):
    ...
    # set the main body or stage of the game scene
    def setStage(self):
    ...
    # set the scoreboard or footer of the game scene
    ...
    # update the character on stage/body
    def updateCharacter(self,t_unit):
        t_posx = t_unit.posx
        
        # if character is AI, position to the right side of the stage
        if (t_unit.playertype=="AI"):
            t_posx = t_unit.posx + self.SCREEN_FLIP_FACTOR

        # load the character on the stage
        ...
        # position and write messages on the stagee
    ...
    # show the the selected unit on the footer of game setup screen
    ...
    # position and display the unit's icon (face profile) on the scoreboard area
    ...
    # update the icon in the scoreboard by putting an X to a dead unit
    ...
    # refresh readouts in the scoreboard
    ...
    #  update the score data in the scoreboard
    ...
    # show the progressbar for the current selected unit on stage
    ...
    # write text in center of the screen
    ...
    # display the unit statistics on scoreboard
...
# This area provides the common functions (not associated with any Class objects)
# can be improved by separating this to a external module.
